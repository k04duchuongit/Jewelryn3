                ...
                <div class="row">
                    ...
                    <div class="col l-6">
                        <form class="detailprd_contents">
                            <h3 class="product-name">bông tai kim cương</h3>
                            <p class="product-price">29,860,000 vnđ</p>
                    ...
                    <div class="sameproduct-listprd">
                        ...
                        <div class="listproduct-content row">
                            <div class="l-3 col">
                                <div class="product">
                                    <div class="product_img"
                                        style="background-image: url(content/images/product/Vonngtay1.jpg);">
                                        <button class="product_addcart">
                                            <a href="">Thêm vào giỏ</a>
                                        </button>
                                    </div>
                                    <p class="product_name">Nhẫn Đẹp Abc</p>
                                    <p class="product_price">3.452.000 vnđ</p>
                                </div>
                            </div>
                            <div class="l-3 col">
                                <div class="product">
                            ...
                            <div class="l-3 col">
                                <div class="product">
                                    <div class="product_img"
                                        style="background-image: url(content/images/product/nhan1.jpg);">
                                        <button class="product_addcart">
                                            <a href="">Thêm vào giỏ</a>
                                        </button>
                                    </div>
